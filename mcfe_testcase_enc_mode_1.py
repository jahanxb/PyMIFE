...
if __name__ == "__main__":
    ...
    print("✓ You can create multiple different key types:")
    print("  - Component extraction keys")
    print("  - Weighted sum keys") 
    print("  - Custom mathematical function keys")
    print("  - Multi-key schemes (generate 2+ keys per computation)")
    print("✓ Both regular and safe key generation supported")
